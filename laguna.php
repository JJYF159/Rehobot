...
<head>
    ...
    <title>Laguna Huascacocha - REHOBOT</title>
            ...
            <section class="seccion-info-proyecto">
                <div class="grid-info">
                    <div class="info-columna">
                        <h3>Importancia</h3>
                        <p>Cuerpo de agua estratégico para la regulación hídrica de la cuenca del Mantaro. Contribuye al control de caudales y garantiza el abastecimiento para consumo humano y agrícola.</p>
                    </div>
                    <div class="separador-vertical"></div>
                    <div class="info-columna">
                        <h3>Descripción del proyecto</h3>
                        <p>Intervención sobre laguna natural con fines de regulación hídrica y posibles usos hidroenergéticos.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="seccion-participacion">
                <div class="contenido-participacion">
                    ...
                    <div class="info-participacion">
                        ...
                        <p>Se desarrollaron trabajos orientados a garantizar el <strong>abastecimiento del recurso hídrico subterráneo para el campamento</strong>, mediante la perforación y equipamiento de sistemas de bombeo confiables.</p>
                    </div>
                ...
                <div class="contenido-actividades">
                    ...
                    <div class="tarjeta-lista-actividades">
                        <ul class="lista-actividades">
                            <li><strong>Perforación de un pozo tubular</strong> para captación de aguas subterráneas.</li>
                            <li><strong>Instalación y equipamiento de sistema de bombeo</strong>, asegurando suministro eficiente para las operaciones.</li>
                            <li><strong>Se ejecutaron tres piezómetros en la represa de la laguna</strong> para el monitoreo y control del nivel freático.</li>
                        </ul>
                    </div>
                </div>
            </section>
