...
<head>
    ...
    <title>Planta de Tratamiento de Agua Potable de Huachipa - SEDAPAL - REHOBOT</title>
        ...
        <div class="contenedor">
            ...
            <section class="header-proyecto">
                ...
                <div class="titulo-con-flecha">
                    ...
                    <h1 class="titulo-proyecto">Planta de Tratamiento de Agua Potable de Huachipa - SEDAPAL</h1>
                </div>
            ...
            <section class="seccion-info-proyecto">
                <div class="grid-info">
                    <div class="info-columna">
                        <h3>Importancia</h3>
                        <p>Una de las plantas más grandes del Perú, con capacidad para abastecer de agua potable a más de 2.4 millones de personas. Es una infraestructura clave para reducir el déficit hídrico en Lima y garantizar el acceso al agua en distritos vulnerables.</p>
                    </div>
            ...
            <section class="seccion-participacion">
                <div class="contenido-participacion">
                    ...
                    <div class="info-participacion">
                        ...
                        <p>Se ejecutó la <strong>construcción de fuentes propias para el abastecimiento del recurso hídrico subterráneo</strong> requeridas durante la etapa de ejecución de la obra y para el funcionamiento posterior de la Planta de Tratamiento Huachipa.</p>
                    </div>
                ...
                <div class="contenido-actividades">
                    ...
                    <div class="tarjeta-lista-actividades">
                        <ul class="lista-actividades">
                            <li><strong>Perforación de dos pozos tubulares</strong> y la instalación de sus respectivos sistemas de bombeo.</li>
                            <li><strong>Perforación y equipamiento de un pozo adicional</strong> en el túnel de transvase.</li>
                        </ul>
                    </div>
                </div>
            </section>
