...
<head>
    ...
    <title>Contacto - REHOBOT</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Lexend:wght@100..900&display=swap" rel="stylesheet">
    <link rel="preload" href="css/contacto.css?v=<?php echo time(); ?>" as="style">
    ...
    <main class="seccion-contacto">
        <div class="contenedor">
            ...
            <div class="formulario-contacto">
                <div class="circulo-azul-contacto"></div>
                <h2>Conversemos</h2>
                
                <form class="formulario" id="formularioContacto" method="POST" action="php/procesar_contacto.php">
                    ...
                    <div class="campos-linea">
                        ...
                        <div class="campo-formulario">
                            ...
                            <input type="tel" id="telefono" name="telefono" placeholder="999 999 999" required maxlength="20">
                        </div>
                    </div>
                    
                    <div class="campo-formulario">
                        <label for="empresa">Empresa / Institución <span class="opcional">(Opcional)</span></label>
                        <input type="text" id="empresa" name="empresa" placeholder="Nombre de tu empresa o institución" maxlength="255">
                    </div>
                    ...
                    <div class="campo-formulario">
                        ...
                        <textarea id="mensaje" name="mensaje" placeholder="Escribe tu consulta" rows="4" required maxlength="5000"></textarea>
                    </div>
